...
if( !class_exists( 'CVCTPostType' ) ) 
{
	class CVCTPostType 
	{
		...
		function __construct()  
		{
			...
			add_action( 'add_meta_boxes_cvct',array($this,'cvct_other_plugins'));	
		...
		function cvct_other_shortcodes_page() {
			...
			$cmb_options->add_field( array(
					'name' => 'Check Our Other Plugins',
					'desc' => '<a target="_blank" href="https://1.envato.market/7QLxy">
					<img src="'.CVCT_URL.'/includes/admin/images/cool-timeline-pro.png">
					</a>
					<a target="_blank" href="https://1.envato.market/a4avW">
					<img src="'.CVCT_URL.'/includes/admin/images/events-calendar-templates.png">
					</a>
					<a target="_blank" href="https://1.envato.market/9raoE">
					<img src="'.CVCT_URL.'/includes/admin/images/crypto-widgets-pro.png">
					</a>',
					'type' => 'title',
					'id'   => 'other-plgins-list'
				) );
		...
		function cvct_register_post_type()
		{
			$labels = array(
				...
				$args = array(
					...
					'menu_position' => 5,
					'menu_icon'=>CVCT_URL.'/includes/admin/images/covid19-tracker.png',
...
/*
		|--------------------------------------------------------------------------
		| Register meta boxes for other plugins
		|--------------------------------------------------------------------------
		*/
		function cvct_other_plugins( $post){
			add_meta_box(
				'cvct-otherplugins-section',
				__( 'Check Our Other Plugins','cvct2'),
				array($this,'cvct_op_section'),
				'cvct',
				'side',
				'low'
			);
...
$pro_add .= '
	...
	'Please give us a rating on <a target="_blank" href="https://codecanyon.net/item/corona-virus-cases-tracker-covid19-tracker/reviews/26055464">Codecanyon</a> or <a target="_blank" href="https://wordpress.org/support/plugin/coronavirus-data-widgets/reviews/#new-post">WordPress.org</a>, it works as a boost for us to work continuously on this plugin in this hard time' .
	'
	<br/>';
...
echo $pro_add;
		...
		/**
		*  other plugins section callback
		*/
		function cvct_op_section($post, $callback){
		global $post;
		$pro_add='';
		
		$pro_add .='<a target="_blank" href="https://1.envato.market/7QLxy">
		<img src="'.CVCT_URL.'/includes/admin/images/cool-timeline-pro.png">
		</a>
		<a target="_blank" href="https://1.envato.market/a4avW">
		<img src="'.CVCT_URL.'/includes/admin/images/events-calendar-templates.png">
