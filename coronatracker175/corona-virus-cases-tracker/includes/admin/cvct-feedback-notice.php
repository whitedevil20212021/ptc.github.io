    ...
    public function admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        <ul>
           ...
           <li class="love_it"><a href="https://codecanyon.net/user/coolplugins/portfolio" class="like_it_btn button button-primary" target="_new" title="Our Other Plugins">Our Other Plugins</a></li>
