...
final class Corona_Virus_Cases_Tracker {
	...
	private function __construct() {
		...
		add_action( 'plugins_loaded', array( $this, 'cvct_load_textdomain' ) );
	...
	$delete_all_cache=get_option('cvct_delete_all_cache');
		if($delete_all_cache==false){
			...
			$countries_arr=cvct_get_country_arr();
			$days_data=30;
...
*/  
	 ...
	 */
	public function cvct_load_textdomain() {
